...
class CodistancingTestCase(TestCase):
    ...
    def test_newline_and_indents__with_line_distance(self):
        self.assert_reformatting_from_data_file("newline_and_indents__with_line_distance.py", line_distance=True)

    def test_comments(self):
        self.assert_reformatting_from_data_file("comments.py", line_distance=True)

    def test_line_distance_after_docstring(self):
        self.assert_reformatting_from_data_file("line_distance_after_docstring.py", line_distance=True)

    def test_no_more_than_two_line_distance(self):
        self.assert_reformatting_from_data_file("no_more_than_two_line_distance.py", line_distance=True)
    ...
    def assert_reformatting_from_data_file(self, test_file, line_distance=False):
        ...
        self.assert_string_reformat(source=source, expected=expected, line_distance=line_distance)
